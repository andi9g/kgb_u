...
<head>
  ...
  <title>Sistem Informasi KGB</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar   text-dark  pinkku2 elevation-4">
    ...
    <a href="{{ url('/home', []) }}" class="brand-link pink-gelapku">
      <h3 class="brand-image rounded-circle bg-info px-1 text-bold" style="padding-top:2px ">KGB</h3>
      <span class="brand-text text-bold text-white" style="font-size: 17px;letter-spacing: 2px">S. Informasi</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item hoverku">
            <a href="{{ url('kgb', []) }}" class="nav-link @yield('activekukgb')">
